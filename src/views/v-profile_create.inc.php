	...
	<body>
		...
		<main id="signup_main">
			...
			<form id="signup_form" action="" method="POST">
				...
				<div class="signup_errors"><?= (isset($errors['social_reason']) ? $errors['social_reason'] : ''); ?></div>
			<?php } ?>
				...
				<div class="signup_errors"><?= (isset($errors['first_name']) ? $errors['first_name'] : ''); ?></div>

				<div class="signup_elmt">
					<label>*Nom :</label>
					<input type="text" name="last_name" maxlength="15" value="<?= (isset($_POST['last_name']) ? $_POST['last_name'] : ''); ?>" required>
				</div>
				<div class="signup_errors"><?= (isset($errors['last_name']) ? $errors['last_name'] : ''); ?></div>

				<div class="signup_elmt">
					<label>*Mail :</label>
					<input type="email" name="mail" maxlength="80" value="<?= (isset($_POST['mail']) ? $_POST['mail'] : ''); ?>" required>
				</div>
				<div class="signup_errors"><?= (isset($errors['mail']) ? $errors['mail'] : ''); ?></div>

				<div class="signup_elmt">
					<label>*Mot de passe :</label>
					<input type="password" name="password" maxlength="64" required>
				</div>
				<div class="signup_errors"><?= (isset($errors['password']) ? $errors['password'] : ''); ?></div>
				...
				<div class="signup_errors"><?= (isset($errors['phone']) ? $errors['phone'] : '');?></div>
				...
				<?php if($account_type == "member") { ?>
					...
					<div class="signup_errors"><?= (isset($errors['birth_date']) ? $errors['birth_date'] : ''); ?></div>
					...
					<div class="signup_errors"><?= (isset($errors['degrees']) ? $errors['degrees'] : ''); ?></div>
				<?php } ?>
